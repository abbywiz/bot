...
struct ClusterInfoArrayResponse_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::interbotix_perception_modules::ClusterInfo_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::interbotix_perception_modules::ClusterInfo_<ContainerAllocator> >> _clusters_type;
